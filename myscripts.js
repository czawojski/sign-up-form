...
function showFirstnameError() {
  if (firstName.validity.valueMissing) {
    ...
    firstNameError.textContent = `First name should be at least ${firstName.minLength} characters; you entered ${firstName.value.length}.`;
  }
...
function showLastnameError() {
  if (lastName.validity.valueMissing) {
    ...
    lastNameError.textContent = `First name should be at least ${lastName.minLength} characters; you entered ${lastName.value.length}.`;
  }
